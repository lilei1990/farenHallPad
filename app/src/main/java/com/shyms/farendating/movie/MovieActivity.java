package com.shyms.farendating.movie;
...
public class MovieActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = "http://"+ PreferencesUtil.getServiceAddress()+"/a.mp4";  //视频播放地址
//        url = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.home).toString();  //视频播放地址
        initVideoPlayer();
    }
    ...
    //视频播放视图回调事件
    private class videoSurfaceView implements SurfaceHolder.Callback {     //上面绑定的监听的事件
        @Override
...
//                MediaPlayer player = MediaPlayer.create(MovieActivity.this, R.raw.home);
...
//                player.start();
    ...
    private void setPalyerListener() {
        ...
        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() { //视频播放完成
            ...
            public void onCompletion(MediaPlayer mp) {
                flag = false;
                playBtn.setBackgroundResource(R.mipmap.btn_play);
            }
        });
        ...
        playBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mediaPlayer.isPlaying()) {
                    ...
                    mediaPlayer.start();
                    playBtn.setBackgroundResource(R.mipmap.btn_pause);
                }
            }
        });
