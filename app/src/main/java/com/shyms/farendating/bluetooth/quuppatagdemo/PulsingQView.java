/**
 * Bocoom Android Tag Emulation Demo application.
 *
 * Copyright 2015 Bocoom Co., Ltd
 *
 * Disclaimer
 ...
 */
package com.shyms.farendating.bluetooth.quuppatagdemo;
...
/**
 * Custom view to render Bocoom O character on it with an pulsing animation.
 */
public class PulsingQView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Path path = new Path();
        path.addArc(cx - logoDim, cy - logoDim, cx + logoDim, cy + logoDim, 100, 360);
