...
public class MyAdapter extends RecyclerView.Adapter<MyViewHolder> {
    ...
    public MyAdapter(List<AffairsInfo.DataEntity> list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        holder.tv_bian_hao.setText(" " + list.get(position).getNumber());
        holder.tv_bu_men.setText(list.get(position).getSection());
