 ...
 * 邮箱登陆
 */
public class MailLoginFragment extends BaseFragment implements View.OnClickListener, MailLoginView {
    ...
    private MailLoginPresenterImp presenterImp;
    private int num = 30;
    ...
    public void initView(View view) {
        super.initView(view);
        tvTitle.setText("邮箱登录");
        presenterImp = new MailLoginPresenterImp(this,getActivity());
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_send_identifying_code:
                presenterImp.getEmailCode(editTextUsername.getText().toString().trim(),"1");
                break;
            case R.id.button_register:
                presenterImp.getEmailLogin(editTextUsername.getText().toString().trim(),identifyingCode.getText().toString().trim());
                break;
        }
    }
